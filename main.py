...
def attack(char_name: str, char_class: str) -> str:
    """Функция рассчитывает и возвращает значения для команды Attack."""
    ...
    return (
        f'{char_name} не умеет атаковать!')


def defence(char_name: str, char_class: str) -> str:
    """Функция рассчитывает и возвращает значения для команды Defence."""
    if char_class == 'warrior':
        return (
    ...
    return (
        f'{char_name} не умеет защищаться!')


def special(char_name: str, char_class: str) -> str:
    """Функция рассчитывает и возвращает значения для команды Special."""
    if char_class == 'warrior':
        return (
    ...
    return (
        f'{char_name} спрашивает, как он сюда попал?')
...
def start_training(char_name: str, char_class: str) -> str:
    ...
    while cmd != 'skip':
        ...
        if cmd == 'attack':
            print(
                attack(char_name, char_class))
        if cmd == 'defence':
            print(
                defence(char_name, char_class))
        if cmd == 'special':
            print(
                special(char_name, char_class))
    return 'Тренировка окончена.'


def choice_char_class() -> str:
    """Функция запускает выбор класса персонажа."""
    ...
    while approve_choice != 'y':
        ...
        if char_class == 'warrior':
            print(
                'Воитель — дерзкий воин ближнего боя. Сильный, выносливый'
                'и отважный.')
        if char_class == 'mage':
            print(
